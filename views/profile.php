        ...
        <div class="max-w-5xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
            <div class="grid sm:grid-cols-1 lg:grid-cols-1 gap-1 sm:gap-6">
                <div class="bg-white overflow-hidden shadow rounded-lg border">
                    <a href="logout"
                        class="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-100 text-red-500 hover:bg-red-200 disabled:opacity-50 disabled:pointer-events-none dark:hover:bg-red-200 dark:text-blue-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
                        Logout
                    </a>
                ...
                <button type="submit"
                    class="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-100 text-blue-600 hover:bg-blue-200 disabled:opacity-50 disabled:pointer-events-none dark:hover:bg-blue-600 dark:text-blue-400 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"">
                    Change
                </button>
                <a href=" /app/deleteUser/<?php echo $user['id'] ?>"
                    class="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-100 text-red-400 hover:bg-red-200 disabled:opacity-50 disabled:pointer-events-none dark:hover:bg-red-200 dark:text-blue-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
                    Delete
                    </a>
                    </form>
                    <div id="hs-cookies"
